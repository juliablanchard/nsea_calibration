...
```
The model is overestimating the yields, likely to do with how the catchability coefficients have been parameterised from stock assessment estimates of fishing mortality rates that capture all age ranges. Let's estimate the catchability based on these time averaged yields. We can do this by writing an "error function" that allows us to optimise (find the minimum value of the error) by adjusting the values of a parameter, in this case catchability.
