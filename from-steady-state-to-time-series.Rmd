...
plots in mizerExperimental. The mizer course notes [here] go through many helpful steps needed to tune, evaluate and check this steady state.
...
The sensitivity to fishing is set by the *reproduction_level* and this parameter and tuning process has a big effect on how species collapse and/or recover through time. 
...
[SHOW HOW THIS COMPARES TO WIDELY USED R_max OPTIMISATION, with/out erepros set to values in jacobsen?]
